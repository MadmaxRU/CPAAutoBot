...
@bot.message_handler(commands=["Начать заново"])
def start_handler(message):
    user_data[message.chat.id] = {}
    bot.send_message(message.chat.id, "🎯 Добро пожаловать! Здесь вы получите максимальную скидку на новое авто. Пройдите короткий опрос — это бесплатно!")
